...
# 모델 로드
# ======================
FILE_ID = st.secrets.get("GDRIVE_FILE_ID", "1pXskBQrYl5FgIuIogt6BrJL0XH_mV_OA")
...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
    ...
    labels[3] : {"texts":["탕수육은 맛있어"],"images" : ["https://img-cf.kurly.com/hdims/resize/%3E720x/quality/90/src/shop/data/goodsview/20221011/gv00000435043_1.jpg"]},
}
